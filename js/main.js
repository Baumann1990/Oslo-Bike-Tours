...
/* ── Gallery rotation ────────────────────────────────────────── */
const GALLERY_POOL = [
  { src: 'images/IMG_2864.webp',                              alt: 'Cyclists overlooking Oslo' },
  { src: 'images/IMG_6329.webp',                              alt: 'Bike along Oslo fjord' },
  { src: 'images/IMG_5813.webp',                              alt: 'Forest rest stop golden light' },
  { src: 'images/IMG_1453.JPG',                               alt: 'Oslo fjord golden hour' },
  { src: 'images/IMG_0270.JPG',                               alt: 'Oslo valley panorama' },
  { src: 'images/IMG_5843.webp',                              alt: 'Group ride in the forest' },
  { src: 'images/IMG_6335.jpg',                               alt: 'Fjord silhouette ride' },
  { src: 'images/IMG_6647.webp',                              alt: 'Lakeside cabin stop' },
  { src: 'images/IMG_5705.webp',                              alt: 'Reservoir dam cycling' },
  { src: 'images/IMG_8055.JPG',                               alt: 'Oslo bike tour' },
  { src: 'images/IMG_6876.JPG',                               alt: 'Oslo cycling' },
  { src: 'images/IMG_7981.webp',                              alt: 'Cycling in Oslo' },
  { src: 'images/IMG_6911.webp',                              alt: 'Oslo landscape' },
  { src: 'images/IMG_6871.webp',                              alt: 'Norwegian scenery' },
  { src: 'images/IMG_6869.webp',                              alt: 'Bike tour Oslo' },
  ...
  { src: 'images/IMG_6630.webp',                              alt: 'Bike stop by forest lake and red cabin' },
  ...
  { src: 'images/IMG_4894.webp',                              alt: 'Gravel bike on Oslo forest road' },
  { src: 'images/IMG_4910.webp',                              alt: 'Cycling through the Nordmarka forest' },
  { src: 'images/IMG_4914.webp',                              alt: 'Gravel riding in Oslo' },
  { src: 'images/christoffer-engstrom-tjguVu0GoEM-unsplash.webp', alt: 'Oslo city skyline reflected at dusk' },
  { src: 'images/delia-giandeini--yz2HFg6WYo-unsplash.webp', alt: 'Bygdøy fjord shore in summer' },
  { src: 'images/hana-clarinda-o0i_hR68r0o-unsplash.webp',   alt: 'Bronze sculpture overlooking Oslo City Hall at golden hour' },
  { src: 'images/hans-joachim-kaiser-_eqvDs2vt1Q-unsplash.webp', alt: 'Traditional wooden boats at Bygdøy harbour' },
  { src: 'images/marius-tandberg--pG0RZ36pXE-unsplash.webp', alt: 'Vigeland Monolith and sculptures, Frogner Park' },
  { src: 'images/nick-night-NY1CGpvtDl4-unsplash.webp',      alt: 'Vigeland Sculpture Park in summer' },
  { src: 'images/nick-night-ujnkOkDXHGQ-unsplash.webp',      alt: 'Aker Brygge waterfront at night' },
  { src: 'images/lawrence-krowdeed-QhgueME61_M-unsplash.webp', alt: 'Rocky Oslofjord shoreline' },
  { src: 'images/lawrence-krowdeed-zXcYUETehx4-unsplash.webp', alt: 'Oslofjord island with white boathouse' },
  { src: 'images/theo-eilertsen-photography-ax6fKJRUMlo-unsplash.webp', alt: 'Oslo City Hall on a winter night' },
  { src: 'images/arsene-m-ovrejorde-BovGw4div6U-unsplash.webp', alt: 'Nordmarka forest trail' },
  { src: 'images/arvid-malde-3VCrw7nHH4A-unsplash.webp',     alt: 'Oslo Opera House rooftop' },
  { src: 'images/eirik-skarstein-y51gnD-B18w-unsplash.webp', alt: 'Gravel cycling in Norway' },
  { src: 'images/emmanuel-appiah-3_NVPVZXYgw-unsplash.webp', alt: 'Oslo street scene' },
  { src: 'images/gjermund-gustavsen-4s09taECQLU-unsplash.webp', alt: 'Norwegian forest landscape' },
  { src: 'images/jack-white-naXbZjqbaTM-unsplash.webp',      alt: 'Oslo architecture and waterfront' },
  { src: 'images/janko-ferlic-McFeZrxySIo-unsplash.webp',    alt: 'Vigeland Sinnataggen sculpture' },
  { src: 'images/leonard-reeb-kn_hml6tRyM-unsplash.webp',    alt: 'Oslo city view' },
  { src: 'images/marcus-chis-z1LZ4-19xb8-unsplash.webp',     alt: 'Oslo fjord panorama' },
  { src: 'images/marleen-mulder-wieske-8oc7EtRZEL8-unsplash.webp', alt: 'Cycling along the Oslofjord' },
  { src: 'images/stenersen.webp',                             alt: 'Stenersen Museum, Oslo' },
  { src: 'images/vidar-nordli-mathisen-q-fr4QsIyic-unsplash.webp', alt: 'Oslo Opera House in morning mist' },
  { src: 'images/IMG_4956.jpeg',                              alt: 'Oslo bike tour' },
  { src: 'images/IMG_4957.jpeg',                              alt: 'Oslo bike tour' },
  { src: 'images/IMG_5024.jpeg',                              alt: 'Oslo bike tour' },
  { src: 'images/IMG_5028.jpeg',                              alt: 'Oslo bike tour' },
  { src: 'images/IMG_5050.jpeg',                              alt: 'Oslo bike tour' },
  { src: 'images/IMG_8055_ig.jpg',                            alt: 'Oslo bike tour' },
];
...
if (form) {
  ...
  form.addEventListener('submit', async e => {
    ...
    try {
      ...
      if (data.success) {
        // Fire Google Ads conversion event, then show confirmation panel
